...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNreserva.setText(ReservaDao.idR+"");
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				huespedDao hd = new huespedDao();
				huesped hp = new huesped();
				hp.setNombre(txtNombre.getText());
				hp.setApellido(txtApellido.getText());
				java.util.Date utilDate = txtFechaN.getDate(); // Obtén la fecha seleccionada como java.util.Date
				if(utilDate != null) {
					java.sql.Date sqlDate = new java.sql.Date(utilDate.getTime()); 
					hp.setFechaNacimiento(sqlDate.toString());
				}
				hp.setNacionalidad(txtNacionalidad.getSelectedItem().toString());
				hp.setTelefono(Double.parseDouble(txtTelefono.getText()));
				hp.setIdReserva(ReservaDao.idR);
				try {
					hd.registrarReserva(hp);
					Exito ex = new Exito();
					ex.setVisible(true);
		            dispose();
